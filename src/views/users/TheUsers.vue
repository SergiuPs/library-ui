  ...
  <base-card size="big-card">
    <h2>The Users</h2>
			...
			<tbody>
				<tr v-for="user in users" :key="user.id">
					...
					<td class="buttons-column">
						<base-button mode="image-small" @click="showModal(user)"><img src="../../assets/information.png" /></base-button>
					</td>
					<td class="buttons-column">
						<base-button mode="image-small"><img src="../../assets/trash.png" /></base-button>
					</td>
				</tr>
			</tbody>
		</table>
		<vue-awesome-paginate
			...
			@click="paginate"
		/>
		<base-dialog :show="showUserInfo " @close="closeModal">
			<user-card :user="userId"></user-card>
		</base-dialog>
  </base-card>
</template>
